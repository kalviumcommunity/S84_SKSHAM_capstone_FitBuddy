...
import { Mail, Lock, User, Dumbbell, ArrowRight, Sun, Moon } from 'lucide-react';
import { signup, googleAuth, clearError } from '../store/slices/authSlice';
    ...
    <PageWrapper>
      ...
      <div className="min-h-screen flex bg-bg">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12">
          ...
          <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-accent/6 rounded-full blur-[100px]" />
          <div className="relative text-center">
            ...
            >
              ...
              <p className="text-muted text-lg max-w-sm mx-auto">
                Create your account and get a personalized AI fitness plan in under 2 minutes.
              </p>
            </motion.div>
          </div>
        </div>
